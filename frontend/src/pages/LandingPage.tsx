  ...
  return (
    <div className="landing-page">
      ...
      <div style={{ color: '#202124', width: '100%', margin: '0 auto' }}>
        ...
        {/* Institutional-Grade Market Intelligence Section */}
        <section className="full-bleed animate-on-scroll" style={{ 
          background: '#ffffff', 
          padding: '4rem 0', 
          position: 'relative'
        }}>
          ...
          <div style={{ 
            ...
            background: `
              linear-gradient(
                ...
                transparent 0%,
                transparent 95%,
                rgba(25, 118, 210, 0.02) 95%,
                rgba(25, 118, 210, 0.02) 97%,
                transparent 97%
              )
            `
          }} />
          <div className="container" style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <h2 style={{ fontSize: '2.5rem', fontWeight: 900, color: '#202124', marginBottom: '0.75rem', lineHeight: 1.2 }}>Institutional‑Grade Market Intelligence</h2>
              <p style={{ fontSize: '1.125rem', color: '#5f6368', marginBottom: '0.75rem' }}>
                We convert market structure, cross‑asset volatility and flow‑driven signals into consistently actionable risk decisions.
              </p>
              <p style={{ fontSize: '1.1rem', color: '#1976d2', marginBottom: '1.25rem', fontStyle: 'italic', fontWeight: '500' }}>
